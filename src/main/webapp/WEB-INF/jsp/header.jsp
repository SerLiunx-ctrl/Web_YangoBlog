    ...
    <nav class="navbar navbar-default" role="navigation" style="background-color: white">
        <div class="container-fluid" style="margin-left: 10%">
            <div class="navbar-header">
                <a class="navbar-brand" href="${pageContext.request.contextPath}/">阳光技术论坛</a>
            </div>
            <div>
                ...
                <ul class="nav navbar-nav navbar-left">
                    <li <c:if test="${tab.tabNameEn == 'tech'}">
                            class="active" </c:if>><a href="${pageContext.request.contextPath}/tab/${type}tech">技术分享</a>
                    </li>
                    <li <c:if test="${tab.tabNameEn == 'play'}">class="active"
                        </c:if>><a href="${pageContext.request.contextPath}/tab/${type}develop">软硬件开发</a></li>
                    <li <c:if test="${tab.tabNameEn == 'creative'}">class="active"
                        </c:if>><a href="${pageContext.request.contextPath}/tab/${type}communicate">话题交流</a></li>
                    <li <c:if test="${tab.tabNameEn == 'jobs'}">class="active"
                         </c:if>><a href="${pageContext.request.contextPath}/tab/${type}help">问题求助</a></li>
                    <li <c:if test="${tab.tabNameEn == 'deals'}">class="active"
                        </c:if>><a href="${pageContext.request.contextPath}/tab/${type}deal">物品交易</a></li>
                </ul>
